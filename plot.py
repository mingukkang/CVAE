...
data_pipeline = data_pipeline("CIFAR_10")
train_xs, train_ys, valid_xs, valid_ys, test_xs, test_ys = data_pipeline.load_preprocess_data()
total_batch = data_pipeline.get_total_batch(train_xs, 100, augment = 1)
batch_xs, batch_ys = data_pipeline.next_batch(train_xs,train_ys,100,augment =1)